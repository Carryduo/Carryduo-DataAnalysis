...
exports.targetChampionSkillInfoSave = async (champId, qSkillInfo, wSkillInfo, eSkillInfo, rSkillInfo, passiveInfo) => {
    try {
        await ChampSkill.createQueryBuilder()
            .insert()
            .values({
...
exports.targetChampionSkillInfoUpdate = async (champId, qSkillInfo, wSkillInfo, eSkillInfo, rSkillInfo, passiveInfo) => {
    try {
        await ChampSkill.createQueryBuilder()
            .update(ChampSkill)
            .set({
